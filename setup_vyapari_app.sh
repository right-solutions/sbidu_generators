if [ $# -eq 0 ]
  then
    echo "Invalid Usage"
    echo "USAGE: sh vyapari_setup.sh <app_name>"
    echo "e.g: sh vyapari_setup.sh demo-site.com"
  else
    ...
    # Run the generator script for setting up vyapari app
    rails g sbidu_generators:vyapari $1
