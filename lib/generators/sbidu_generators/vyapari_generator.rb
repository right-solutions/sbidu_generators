...
class SbiduGenerators::VyapariGenerator < Rails::Generators::Base
  
  source_root File.expand_path('../vyapari_templates', __FILE__)
  desc "Copies the basic files to kick start a new vyapari app"
